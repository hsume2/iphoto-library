...
=== Known Issues
* rake iphoto:update task is only incremental on new events and photos. Changes to event names and photo captions are not synchronized. More work to be done here.
